function timThuoc() {
  ...
  if (selectedValue == "tenbietduoc") {
    fetch(`https://backend-flame-nine.vercel.app/qlnt/thuoc/tbd/${cn}/${inputtk.value}`)
    ...
    fetch(`https://backend-flame-nine.vercel.app/qlnt/thuoc/hc/${cn}/${inputtk.value}`)
      .then(function (response) {
        if (!response.ok) {
          throw Error(response.statusText);
        }
    ...
    fetch(`https://backend-flame-nine.vercel.app/qlnt/thuoc/nt/${cn}/${inputtk.value}`)
      .then(function (response) {
        if (!response.ok) {
          throw Error(response.statusText);
        }
